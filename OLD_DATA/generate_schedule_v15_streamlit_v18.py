...
st.title("整形済スケジュール v19 Webアプリ版（次ヘッダー混入 修正版＋罫線＋全セル整形）")
...
output_filename = st.text_input("出力ファイル名（例：整形スケジュール_v19.xlsx）", "整形スケジュール_v19.xlsx")
